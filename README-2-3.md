...
|---|---|
| ![Terminal setup 1](01-terminal-setup-1.png) | Homebrew, Java, and Docker installation checks |
| ![Terminal setup 2](02-terminal-setup-2.png) | `docker pull vulnerables/web-dvwa` completing successfully |
| ![DVWA Home](03-dvwa-home.png) | DVWA welcome/home page after successful setup |
| ![Security Level](04-security-level-low.png) | DVWA Security page confirming Low security level |
...
|---|---|
| ![Normal SQLi input](05-sqli-normal-input.png) | ![SQLi payload result](06-sqli-payload-result.png) |
...
![Blind SQL Injection](19-sqli-blind.png)
...
|---|---|
| ![Normal ping](07-cmdi-normal-ping.png) | ![Command injection success](08-cmdi-payload-result.png) |
...
|---|---|---|
| ![XSS reflected form](09-xss-reflected-form.png) | ![XSS reflected result](10-xss-reflected-result.png) | ![XSS reflected alert](11-xss-reflected-alert.png) |
...
|---|---|
| ![Stored XSS form](12-xss-stored-form.png) | ![Stored XSS alert](13-xss-stored-alert.png) |
...
```
Injected via the `default` URL parameter, manipulated client-side without any server round-trip.
...
![DOM XSS alert](18-dom-xss-alert.png)
...
![CSRF password changed](16-csrf-password-changed.png)
...
![File upload success](15-file-upload-success.png)
...
![Weak session IDs](17-weak-session-ids.png)
...
![Brute force page](14-brute-force-page.png)
